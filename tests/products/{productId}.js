...
/**
 * Test for /products/{productId}
 */
Test('/products/{productId}', function (t) {
...
available inventory in the system
         ...
         * responses: 200, 400
         */
        t.test('test getProduct get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/products/{productId}']['get']['responses']['200']['schema']);
         ...
         */
        t.test('test deleteProduct delete operation', function (t) {
            Mockgen().requests({
                path: '/products/{productId}',
                operation: 'delete'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    t.ok(res.statusCode === 200, 'Ok response status');
                    var Validator = require('is-my-json-valid');
                    var validate = Validator(api.paths['/products/{productId}']['delete']['responses']['200']['schema']);
                    var response = res.body;
                    if (Object.keys(response).length <= 0) {
                        response = res.text;
                    }
         ...
         * responses: 200, 400
         */
        t.test('test editProduct put operation', function (t) {
            Mockgen().requests({
                path: '/products/{productId}',
                operation: 'put'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    t.ok(res.statusCode === 200, 'Ok response status');
                    var Validator = require('is-my-json-valid');
                    var validate = Validator(api.paths['/products/{productId}']['put']['responses']['200']['schema']);
                    var response = res.body;
                    if (Object.keys(response).length <= 0) {
                        response = res.text;
                    }
