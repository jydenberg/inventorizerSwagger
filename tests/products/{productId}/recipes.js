...
/**
 * Test for /products/{productId}/recipes
 */
Test('/products/{productId}/recipes', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 400
         */
        t.test('test searchRecipeByProduct get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/products/{productId}/recipes']['get']['responses']['200']['schema']);
        ...
        t.test('test DeleteProduct delete operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    t.ok(res.statusCode === 200, 'Ok response status');
                    var Validator = require('is-my-json-valid');
                    var validate = Validator(api.paths['/products/{productId}/recipes']['delete']['responses']['200']['schema']);
                    var response = res.body;
                    if (Object.keys(response).length <= 0) {
                        response = res.text;
                    }
         ...
         * responses: 200, 400
         */
        t.test('test editRecipeByProduct put operation', function (t) {
            Mockgen().requests({
                path: '/products/{productId}/recipes',
                operation: 'put'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    t.ok(res.statusCode === 200, 'Ok response status');
                    var Validator = require('is-my-json-valid');
                    var validate = Validator(api.paths['/products/{productId}/recipes']['put']['responses']['200']['schema']);
                    var response = res.body;
                    if (Object.keys(response).length <= 0) {
                        response = res.text;
                    }
