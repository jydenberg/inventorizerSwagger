...
/**
 * Test for /materials/{materialId}
 */
Test('/materials/{materialId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 400
         */
        t.test('test getMaterial get operation', function (t) {
            Mockgen().requests({
         ...
         * responses: 201, 400
         */
        t.test('test deleteMaterial delete operation', function (t) {
            Mockgen().requests({
                path: '/materials/{materialId}',
                operation: 'delete'
            }, function (err, mock) {
         ...
         * responses: 200, 400
         */
        t.test('test editMaterial put operation', function (t) {
            Mockgen().requests({
                path: '/materials/{materialId}',
                operation: 'put'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/materials/{materialId}']['put']['responses']['200']['schema']);
