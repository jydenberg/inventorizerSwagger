...
available inventory in the system
         ...
         * responses: 200, 400
         */
        t.test('test getProducts get operation', function (t) {
            Mockgen().requests({
                path: '/products',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/products']['get']['responses']['200']['schema']);
         ...
         */
        t.test('test addProduct post operation', function (t) {
            Mockgen().requests({
                path: '/products',
                operation: 'post'
            }, function (err, mock) {
