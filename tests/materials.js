...
available inventory in the system
         ...
         * responses: 200, 400
         */
        t.test('test getMaterials get operation', function (t) {
            Mockgen().requests({
                path: '/materials',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/materials']['get']['responses']['200']['schema']);
         ...
         */
        t.test('test addMaterial post operation', function (t) {
            Mockgen().requests({
                path: '/materials',
                operation: 'post'
            }, function (err, mock) {
